...
/**
 * @brief 2D Sedov-Taylor Blast Wave Problem using DISPH
 * 
 * 2D point explosion in a uniform medium using Density Independent SPH (DISPH).
 * Tests shock handling and energy conservation in 2D with pressure-energy formulation.
 * 
 * Initial conditions:
 ...
 * 
 * DISPH features:
 * - Pressure-energy formulation (better for pressure-dominated flows)
 * - Better conservation properties than standard SPH
 * - Good shock capturing without needing GSPH reconstruction
 */
class SedovTaylor2DPlugin : public SimulationPlugin {
public:
    std::string get_name() const override {
        return "sedov_taylor_2d";
    }
    
    std::string get_description() const override {
        return "2D Sedov-Taylor blast wave using DISPH - circular explosion in 2D";
    }
    ...
    void initialize(std::shared_ptr<Simulation> sim,
        ...
        std::cout << "Initializing 2D Sedov-Taylor blast wave (DISPH)...\n";
        ...
        std::cout << "  Method: DISPH (Density Independent SPH)\n";
...
// Export the plugin
DEFINE_SIMULATION_PLUGIN(sph::SedovTaylor2DPlugin)
